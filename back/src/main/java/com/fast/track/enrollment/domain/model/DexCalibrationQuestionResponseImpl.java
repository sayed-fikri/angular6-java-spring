...
@Entity(name = "DexCalibrationQuestionResponse")
@Table(name = "DEX_CLBR_QSTN_RSPN")
public class DexCalibrationQuestionResponseImpl implements DexCalibrationQuestionResponse {
    ...
    @ManyToOne(targetEntity = DexCalibrationSectionResponseImpl.class,
            cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "RESPONSE_ID")
    private DexCalibrationSectionResponse sectionResponse;
    ...
    @Override
    public DexCalibrationSectionResponse getSectionResponse() { return sectionResponse; }

    @Override
    public void setSectionResponse(DexCalibrationSectionResponse sectionResponse) { this.sectionResponse = sectionResponse; }
    ...
    public Class<?> getInterfaceClass() {
        return DexCalibrationQuestionResponse.class;
    }
}
